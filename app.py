# app.py (V9.32 - FINAL GOLD)
# Visual Locks, 5 Layers, Logo Fix, Full Translations
...
def render_footer():
    ...
    st.markdown(f"""
        <div class="footer-container">
            <div class="footer-row-1">© 2025-2026 LAI'S LAB &nbsp; • &nbsp; <span style="color:#999;font-weight:400;">SYSTEM V9.32 GOLD</span> &nbsp; • &nbsp; <span style="color:{tier_color}">{tier_label}</span></div>
